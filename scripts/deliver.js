...
async function sendEmail(text, apiKey, toEmails, fromEmail) {
  ...
  try {
    switch (delivery.method) {
      ...
      case 'email': {
        ...
        const fromEmail = delivery.from || process.env.RESEND_FROM || 'AI Builders Digest <digest@digest.yianz.me>';
        ...
        await sendEmail(digestText, apiKey, toEmails, fromEmail);
        console.log(JSON.stringify({
          status: 'ok',
          method: 'email',
